...
func (in *EngineSpec) DeepCopyInto(out *EngineSpec) {
	*out = *in
	...
	if in.ReplicaTransportAddressMap != nil {
		in, out := &in.ReplicaTransportAddressMap, &out.ReplicaTransportAddressMap
		*out = make(map[string]ReplicaTransportAddresses, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	...
	if in.QosLimits != nil {
		in, out := &in.QosLimits, &out.QosLimits
		*out = new(QosLimits)
		**out = **in
	}
	return
...
func (in *EngineStatus) DeepCopyInto(out *EngineStatus) {
	*out = *in
	...
	if in.CurrentReplicaTransportAddressMap != nil {
		in, out := &in.CurrentReplicaTransportAddressMap, &out.CurrentReplicaTransportAddressMap
		*out = make(map[string]ReplicaTransportAddresses, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	...
	if in.LastAppliedQosLimits != nil {
		in, out := &in.LastAppliedQosLimits, &out.LastAppliedQosLimits
		*out = new(QosLimits)
		**out = **in
	}
	return
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *QosLimits) DeepCopyInto(out *QosLimits) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new QosLimits.
func (in *QosLimits) DeepCopy() *QosLimits {
	if in == nil {
		return nil
	}
	out := new(QosLimits)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReplicaTransportAddresses) DeepCopyInto(out *ReplicaTransportAddresses) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReplicaTransportAddresses.
func (in *ReplicaTransportAddresses) DeepCopy() *ReplicaTransportAddresses {
	if in == nil {
		return nil
	}
	out := new(ReplicaTransportAddresses)
	in.DeepCopyInto(out)
	return out
}
